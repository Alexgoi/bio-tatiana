  ...
  return (
    <div className="layout">
      ...
      <nav className="link-list">
        ...
        <a href="https://produto.mercadolivre.com.br/MLB-6224416342-livro-assembleias-condominiais-desafios-e-solucoes-para-uma-gesto-eficaz-tatiana-lima-_JM" className="minimal-link" target="_blank" rel="noopener noreferrer">
          <IoBookSharp className="icon" />
          <span>Livro Assembleias Condominiais</span>
        </a>
